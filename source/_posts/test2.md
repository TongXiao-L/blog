---
title: 我的 VSCode 配置
date: 2020-06-28 21:14:56
updated: 2021-05-28 21:14:56
...
> 此文章来源于https://github.com/romkatv/powerlevel10k，仅供测试使用
...
- [VSCode 的下载和安装](#vscode-的下载和安装)
  ...
  - [FAQ](#faq)
    ...
    - [How do I export GPG\_TTY when using instant prompt?](#how-do-i-export-gpg_tty-when-using-instant-prompt)
  ...
  - [Troubleshooting](#troubleshooting)
    ...
    - [Cursor is in the wrong place](#cursor-is-in-the-wrong-place)
      - [If the prompt line aligns with the frame](#if-the-prompt-line-aligns-with-the-frame)
      - [If the prompt line is longer than the frame](#if-the-prompt-line-is-longer-than-the-frame)
      - [If the prompt line is shorter than the frame and is mangled](#if-the-prompt-line-is-shorter-than-the-frame-and-is-mangled)
      - [If the prompt line is shorter than the frame and is not mangled](#if-the-prompt-line-is-shorter-than-the-frame-and-is-not-mangled)
    ...
    - [Horrific mess when resizing terminal window](#horrific-mess-when-resizing-terminal-window)
      - [The anatomy of the problem](#the-anatomy-of-the-problem)
      - [Zsh patch](#zsh-patch)
